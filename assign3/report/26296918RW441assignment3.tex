...
\begin{table}[htbp]
	...
	\begin{tabular}{|l|c|l|l|}
		\hline
		\textbf{Dataset} & \textbf{Missing Values} & \textbf{Distribution / Notes} & \textbf{Source} \\
		\hline
		Iris & none & \begin{tabular}[c]{@{}l@{}}setosa -- 33.3\% \\ versicolor -- 33.3\% \\ virginica -- 33.3\%\end{tabular} & \cite{iris} \\
		\hline
		Wine & none & \begin{tabular}[c]{@{}l@{}}cultivar 0 -- 33.1\% \\ cultivar 1 -- 39.9\% \\ cultivar 2 -- 27.0\%\end{tabular} & \cite{wine} \\
		\hline
		Fashion-MNIST & none & 10 equally distributed classes & \cite{mnist} \\
		\hline
		Sine + Noise & none & synthetic sinusoidal + Gaussian noise & synthetic \\
		\hline
		California Housing & few & housing variables, spatial data & \cite{housing} \\
		\hline
		Energy Efficiency & none & building energy data, multiple targets & \cite{energy} \\
		\hline
	\end{tabular}
\end{table}
