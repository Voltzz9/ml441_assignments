...
\begin{table*}[htbp]
	...
	\begin{tabular}{@{} l c l l @{}}
		...
		\midrule
		Iris & none & \makecell{setosa - 33.3\% \\ versicolor - 33.3\% \\ virginica - 33.3\%} & \cite{iris} \\
		Wine & none & \makecell{cultivar 0 - 33.1\% \\ cultivar 1 - 39.9\% \\ cultivar 2 - 27.0\%} & \cite{wine} \\
		...
		Energy Efficiency & none & building energy data, multiple target variables & \cite{energy} \\
		\bottomrule
	\end{tabular}
\end{table*}
